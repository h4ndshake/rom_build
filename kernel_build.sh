...
# This is a scrpt used to build custom kernels, if you are gonna use it, you need to change the lines 15, 16 and 23. According with your environment.
